...
<div class="meta"><b>参赛类别</b><span>端到端系统（End-to-End System）</span><b>团队</b><span>Orgalyst Lab：Xiaoyan Li（AI / 计算机视觉 / 大模型应用，项目负责人）；许力文、付旭正（生物学，类器官培养与形态学判读，负责需求与结果审核）；姜翠翠（AI，大模型、Agent 架构与编排）；杨茹美</span><b>代码</b><span>https://github.com/xiaoyanLi629/orgalyst（MIT）</span><b>权重</b><span>https://huggingface.co/XiaoyanLi/orgalyst-weights</span><b>数据</b><span>OrgLine（Zenodo 16355179，CC-BY-4.0），未使用任何私有数据</span></div>
</header>
